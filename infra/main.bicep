...
param webapiName string = 'webapi-${replace(environmentName, ' ', '-')}-${uniqueString(subscription().id)}'
...
module serverfarm 'br:mcr.microsoft.com/bicep/avm/res/web/serverfarm:0.4.1' = {
  name: 'appserviceplan'
  scope: resourceGroup
  params: {
...
module webapi 'br:mcr.microsoft.com/bicep/avm/res/web/site:0.15.1' = {
  name: 'webapi'
  scope: resourceGroup
  params: {
    name: webapiName
